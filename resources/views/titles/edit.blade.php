                ...
                <form method="post" action="{{ route('titles.update', $title->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 sm:p-6">
                            ...
                            <select name="themes" id="themes" class="form-multiselect block rounded-md shadow-sm mt-1 block w-full" multiple="multiple" value="{{ old('themes', '') }}">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="year" id="year" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('year', '') }}" />
                            @error('year')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
